    ...
    <footer className="footer">
      ...
      <div className="container">
        <div className="footer-main">
          ...
          <div className="footer-brand">
            <div className="footer-logo">
              ...
              <div>
                <div className="footer-logo-name">Caffeestan Coffee</div>
          ...
          <div className="footer-nav">
            ...
            <div className="footer-col">
              ...
              <a href="https://instagram.com/Caffeestan.coffee_" target="_blank" rel="noopener noreferrer" className="footer-link">@Caffeestan.coffee_</a>
        ...
        <div className="footer-bottom">
          <span>© 2026 Caffeestan Coffee · Tüm hakları saklıdır.</span>
